<template>
    <div class="calendar">
            ...
            <span class="calendar-prev" @click="prev">
                ...
                <g class="transform-group">
                    <g transform="scale(0.015625, 0.015625)">
                        <path d="M671.968 912c-12.288 0-24.576-4.672-33.952-14.048L286.048 545.984c-18.752-18.72-18.752-49.12 0-67.872l351.968-352c18.752-18.752 49.12-18.752 67.872 0 18.752 18.72 18.752 49.12 0 67.872l-318.016 318.048 318.016 318.016c18.752 18.752 18.752 49.12 0 67.872C696.544 907.328 684.256 912 671.968 912z" fill="#007BE6"></path>
                    </g>
                </g>
                </svg>
            </span>
        ...
        <tr v-for="(day,k1) in days" style="{'animation-delay',(k1*30)+'ms'}">
            <td v-for="(child,k2) in day" :class="{'selected':child.selected,'disabled':child.disabled,'during':child.during}" @click="select(k1,k2,$event)">
...
.calendar td span{
    ...
    margin:0px auto;
    border-radius:34px;
    color: rgba(36,37,61,1)!important;
}
...
.calendar td.selected span{
    background-color: rgba(255,218,0,1)!important;
    color: #fff!important;
}
.calendar td.during span{
